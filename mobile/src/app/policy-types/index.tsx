...
import { IPolicyType } from '@/src/models/policyType.interface'
import { useDeletePolicyTypeMutation, useGetPolicyTypesQuery } from '@/src/redux/apis/policyType.api'
...
const PolicyTypes = () => {
    ...
    const { data, isLoading, refetch } = useGetPolicyTypesQuery({
        page: page + 1,
        limit: itemsPerPage,
        searchQuery: debounceSearchQuery.toLowerCase(),
        selectedUser
    })
    const [deletePolicyType, { data: message, isSuccess }] = useDeletePolicyTypeMutation()
    ...
    const handleSort = (key: string) => {
        ...
        setPolicyTypes([...policyTypes].sort((a, b) => {
